...
Requierements: you must install the Python libraries necessary for crawling, GroundX API interaction, and generation using the OpenAI SDK. Run the following command in your terminal to ensure all mandatory dependencies are installed: 
...
The results with screenshots are shown in *Results.pdf*
